...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    img(src='@/assets/curso/temas/tema3/img-5.jpg' data-aos="fade-right")
      ...
      TabsA.color-acento-contenido.mb-5.tabs-edit.w-100(data-aos="fade-right")
        .tarjeta.d-flex.flex-wrap.p-4(titulo="Naturaleza" style="background-color: #E1F3D7")
          .col-xl-7.pe-xl-4
            ...
            p.mb-0 En esta característica se deben articular entre otros aspectos, los tipos de organización y las políticas de gestión del cambio, contrastándolas según el objeto  de análisis de datos proyectado.
        ...
        .tarjeta.d-flex.flex-wrap.p-4(titulo="Acceso" style="background-color: #E1F3D7")
          .col-xl-7.pe-xl-4
            ...
            p.mb-0 De manera previa se debe prever cómo se puede obtener el acceso a la información, que sea objeto de un análisis, por lo que es importante aplicar recursos como los consentimientos informados, con esto se podrá tener un panorama aprobado para la aplicación de los instrumentos a utilizar. 
          Zoom(
            lente="200" 
        ...
        .tarjeta.d-flex.flex-wrap.p-4(titulo="Tamaño" style="background-color: #E1F3D7")
          .col-xl-7.pe-xl-4
            ...
            p.mb-0 Se deben articular los resultados de las población, muestreo y determinación de la muestra, porque teniendo claridad de estos datos, tendremos una visual de la magnitud de los instrumentos requeridos y cuál técnica será la más favorable para el levantamiento, tratamiento y análisis de la información. 
          Zoom(
            lente="200" 
        ...
        .tarjeta.d-flex.flex-wrap.p-4(titulo="Recursos" style="background-color: #E1F3D7")
          .col-xl-7.pe-xl-4
            ...
            p.mb-0 Los recursos con que cuenta el analista son vitales para la disposición de herramientas, cuando hablamos de  estos debemos tener en cuenta: los económicos, los humanos, tecnológicos, logísticos, entre muchos otros.
              br
              br
        ...
        .tarjeta.d-flex.flex-wrap.p-4(titulo="Tipo y naturaleza" style="background-color: #E1F3D7")
          .col-xl-7.pe-xl-4
            ...
            p.mb-0 Verifique las fuentes de información, acá es importante evaluar de dónde vamos a obtener la información, lo cual nos permitirá focalizar los  recursos y las técnicas correctas que se vayan aplicar.
